...
import com.example.springrestvotingsystem.dto.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handle(VoterNotFoundException e) {
    ...
    public ResponseEntity<ErrorResponse> handle(VoterAlreadyExistsException e) {
    ...
    public ResponseEntity<ErrorResponse> handle(FileException e) {
        ...
        ErrorResponse errorResponse = new ErrorResponse(e.getMessage(), Error.FILE_ERROR, 400);
    ...
    public ResponseEntity<ErrorResponse> handle(FileNotFoundException e) {
        ...
        ErrorResponse errorResponse = new ErrorResponse(
                String.format("File not found: filename = %s", e.getFilename()), Error.FILE_NOT_FOUND, 404);
